...
Parcel data was retrieved from the Adams, Arapahoe, Broomfield, Boulder, Denver, Douglas, and Jefferson County assessor's offices. Current plan is to limit the data to single family homes, and update the housing affordability metric once the Fed posts interest rates at the end of Q2.
...
*
    ...
    + update affordability metric 
    + explore dynamic credit score input
