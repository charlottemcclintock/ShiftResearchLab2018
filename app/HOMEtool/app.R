...
ui <- shinyUI(fluidPage(theme = "bootstrap.css",
        ...
        mainPanel(tabsetPanel(type = "tabs",
          ...
          tabPanel("Statistics", 
                   ...
                   tags$h3(textOutput("occ_name")), 
                   tags$h4(textOutput("ind_name")),
                   br(),
                   div(id="container", tags$h3(textOutput("income")), 
                       tags$p(" median annual income for an individual in this occupation.")),
                   br(),
                   div(id="container", tags$p("The median income for this occupation is "), 
                       tags$h3(textOutput("rel_percent")), " percent of the Denver metro area median income."),
                   br(),
                   div(id="container", 
                       tags$p("The range between 25th and 75th percentiles for this occupation is "), 
                       tags$h3(textOutput("range")), "."),
                   br(),
                   div(id="container", tags$h3(textOutput("percent")), 
                       tags$p("of all houses in the Denver metro area are affordable for this occupation.")),
                   br(),
                   div(id="container", tags$p("The median income for this occupation is "), 
                       tags$h3(textOutput("occ_percent")), " percent of the industry median wage.")
                  ),
          tabPanel("About", 
                   ...
                   tags$strong("Occupational Wages"),
